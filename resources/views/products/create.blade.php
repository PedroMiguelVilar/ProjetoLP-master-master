                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" required autocomplete="quantity">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control" step=".01" name="price" required autocomplete="price">
                            </div>
                        </div>
