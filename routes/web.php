...
Route::middleware(['auth'])->group(function() {
    ...
    Route::delete('/products/image/{product}', [FileUploadController::class, 'imagedestroy'])->name('image.destroy')->middleware('Role_Admin');
    ...
    Route::delete('/myproducts/image/{product}', [FileUploadController::class, 'imagedestroy'])->name('myimage.destroy');
